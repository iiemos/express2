layui.use([],function () {
    ...
    window.openinfo = function (fitter) {
        ...
        if(!fitter.phone){
            if(!datas.phone){
                layer.msg('The mobile phone cannot be empty.');
                return false;
            }
        }
        ...
        if(!fitter.area){
            if(!datas.area){
                layer.msg('The region cannot be empty');
                return false;
            }
        }
        ...
        if(!fitter.youbian){
            if(!datas.youbian){
                layer.msg('Postcode cannot be empty');
                return false;
            }
        }
        ...
        if(!fitter.address_num){
            if(!datas.address_num){
                layer.msg('The house number cannot be empty');
                return false;
            }
        }
        ...
        if(!fitter.home){
            if(!datas.home){
                layer.msg('The home cannot be empty');
                return false;
            }
        }
